...
let tickerLogoOffset: [String: CGPoint] = [
    ...
    "035760.KQ": CGPoint(x:  2, y:  0), // CJ ENM
    "214370.KQ": CGPoint(x:  0, y:  1), // 케어젠
    "253450.KQ": CGPoint(x:  0, y:  2), // 스튜디오드래곤
]
...
let tickerLogoPadding: [String: CGFloat] = [
    ...
    "007390.KQ": -2,  // 네이처셀
    "028300.KQ": 0,   // HLB
    "031980.KQ": 7,   // 피에스케이홀딩스
    "032190.KQ": 5,   // 다우데이타
    "032820.KQ": 0,   // 우리기술
    "035900.KQ": 10,  // JYP Ent.
