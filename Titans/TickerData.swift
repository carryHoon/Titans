...
let tickerDomain: [String: String] = [
    ...
    "9532":    "osakagas.co.jp",
    // Euronext (파리/암스테르담/밀라노) — 앱 티커 = TD 심볼. TTE·ASML은 US 리스팅 키로 이미 존재해 제외.
    // logo.dev 미커버 도메인은 이니셜 폴백(무해).
    "MC":      "lvmh.com",
    "OR":      "loreal.com",
    "RMS":     "hermes.com",
    "SAN":     "sanofi.com",
    ...
    "ABN":     "abnamro.com",
    "KPN":     "kpn.com",
    "DSFIR":   "dsm-firmenich.com",
    "RACE":    "ferrari.com",
    "ENEL":    "enel.com",
    "ISP":     "intesasanpaolo.com",
    "UCG":     "unicreditgroup.eu",
    "G":       "generali.com",
    "STLAM":   "stellantis.com",
    "ENI":     "eni.com",
    "TIT":     "gruppotim.it",
